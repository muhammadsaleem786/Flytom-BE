...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Flyttom.API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                option.SwaggerEndpoint($"/swagger/v1/swagger.json", "Flyttom.API v1");
                option.RoutePrefix = "";
        ...
        private void InitializeDatabase(IApplicationBuilder app)
        {
            ...
            scope.ServiceProvider.GetRequiredService<FlyttomContext>().Database.Migrate();
        }
    }
}
